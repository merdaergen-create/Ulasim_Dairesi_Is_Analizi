...
flowchart TD
    ...
    C -- Hayır --> D[Geometrik, işaretleme, eğitim veya denetim alternatifi<br/>Sorumlu: Ulaşım Veri Platformu ve Analitik Sorumlusu<br/>Birim: Veri, Güvenlik ve Platform Birimi]
    ...
    G -- Hayır --> H[Proje kapsamı/yer/yöntem revizyonu<br/>Sorumlu: Ulaşım Teknolojileri Proje Yöneticisi<br/>Birim: AUS Sistemleri ve Entegrasyon Birimi]
    H --> E
    ...
    I --> J[Bilgi güvenliği, KVKK, ağ ve süreklilik tasarımı<br/>Sorumlu: Haberleşme, Ağ ve Siber Güvenlik Mühendisi<br/>Birim: Veri, Güvenlik ve Platform Birimi]
    ...
    K --> L[İhale ve tedarik süreci<br/>Sorumlu: Ulaşım Teknolojileri Proje Yöneticisi<br/>Birim: AUS Sistemleri ve Entegrasyon Birimi]
    ...
    M --> N[Elektriksel, fonksiyonel, veri ve siber güvenlik testleri<br/>Sorumlu: Haberleşme, Ağ ve Siber Güvenlik Mühendisi<br/>Birim: Veri, Güvenlik ve Platform Birimi]
    N --> O{Kabul kriterleri sağlandı mı?<br/>Sorumlu: Haberleşme, Ağ ve Siber Güvenlik Mühendisi<br/>Birim: Veri, Güvenlik ve Platform Birimi}
    O -- Hayır --> P[Düzeltme ve tekrar test<br/>Sorumlu: Ulaşım Teknolojileri Proje Yöneticisi<br/>Birim: AUS Sistemleri ve Entegrasyon Birimi]
    P --> N
    O -- Evet --> Q[Ortak kabul: Planlama + AUS + yetkili kurum<br/>Sorumlu: Ulaşım Teknolojileri Proje Yöneticisi<br/>Birim: AUS Sistemleri ve Entegrasyon Birimi]
...
```mermaid
flowchart TD
    A([Yeni veri kaynağı veya analiz ihtiyacı<br/>Sorumlu: Ulaşım Veri Platformu ve Analitik Sorumlusu<br/>Birim: Veri, Güvenlik ve Platform Birimi]) --> B[İş sahibi şube: amaç ve karar ihtiyacı<br/>Sorumlu: AUS ve TKM Şube Müdürü<br/>Birim: Şube Müdürlüğü Yönetimi]
    ...
    C --> D[Veri sahibi, erişim rolü ve saklama süresi<br/>Sorumlu: Haberleşme, Ağ ve Siber Güvenlik Mühendisi<br/>Birim: Veri, Güvenlik ve Platform Birimi]
    D --> E[KVKK, bilgi güvenliği ve paylaşım kontrolü<br/>Sorumlu: Haberleşme, Ağ ve Siber Güvenlik Mühendisi<br/>Birim: Veri, Güvenlik ve Platform Birimi]
    ...
    G --> E
    F -- Evet --> H[ETL/API ve veri sözlüğü<br/>Sorumlu: Ulaşım Veri Platformu ve Analitik Sorumlusu<br/>Birim: Veri, Güvenlik ve Platform Birimi]
    H --> I[Doğruluk, tamlık, güncellik ve tekillik kontrolleri<br/>Sorumlu: AUS ve TKM Şube Müdürü<br/>Birim: Şube Müdürlüğü Yönetimi]
    I --> J{Kalite eşiği sağlandı mı?<br/>Sorumlu: Haberleşme, Ağ ve Siber Güvenlik Mühendisi<br/>Birim: Veri, Güvenlik ve Platform Birimi}
    ...
    K --> I
    J -- Evet --> L[Veri kataloğu ve erişim yetkisi<br/>Sorumlu: Haberleşme, Ağ ve Siber Güvenlik Mühendisi<br/>Birim: Veri, Güvenlik ve Platform Birimi]
    L --> M[Gösterge paneli, model veya rapor<br/>Sorumlu: Ulaşım Veri Platformu ve Analitik Sorumlusu<br/>Birim: Veri, Güvenlik ve Platform Birimi]
...
flowchart TD
    ...
    C --> D[AUS: ekran, ses, enerji, ağ ve veri tasarımı<br/>Sorumlu: Haberleşme, Ağ ve Siber Güvenlik Mühendisi<br/>Birim: Veri, Güvenlik ve Platform Birimi]
    D --> E{Altyapı uygun mu?<br/>Sorumlu: Ulaşım Veri Platformu ve Analitik Sorumlusu<br/>Birim: Veri, Güvenlik ve Platform Birimi}
    E -- Hayır --> F[Alternatif enerji/haberleşme veya durak revizyonu<br/>Sorumlu: Haberleşme, Ağ ve Siber Güvenlik Mühendisi<br/>Birim: Veri, Güvenlik ve Platform Birimi]
    F --> D
    E -- Evet --> G[Tedarik ve kurulum<br/>Sorumlu: Ulaşım Teknolojileri Proje Yöneticisi<br/>Birim: AUS Sistemleri ve Entegrasyon Birimi]
    ...
    H --> I[Erişilebilirlik, içerik ve teknik test<br/>Sorumlu: Ulaşım Teknolojileri Proje Yöneticisi<br/>Birim: AUS Sistemleri ve Entegrasyon Birimi]
    I --> J{Kabul uygun mu?<br/>Sorumlu: Ulaşım Teknolojileri Proje Yöneticisi<br/>Birim: AUS Sistemleri ve Entegrasyon Birimi}
    ...
    O --> R[Servis testi ve kapanış<br/>Sorumlu: Ulaşım Teknolojileri Proje Yöneticisi<br/>Birim: AUS Sistemleri ve Entegrasyon Birimi]
    P --> R
    Q --> R
```
...
flowchart TD
    ...
    J --> K[Güvenli ortamda teslim ve teslim tutanağı<br/>Sorumlu: Haberleşme, Ağ ve Siber Güvenlik Mühendisi<br/>Birim: Veri, Güvenlik ve Platform Birimi]
    K --> L[Tüm erişim, kopyalama ve teslim işlemlerinin loglanması<br/>Sorumlu: Haberleşme, Ağ ve Siber Güvenlik Mühendisi<br/>Birim: Veri, Güvenlik ve Platform Birimi]
...
flowchart LR
    ...
    D --> E[Uygulama, ağ, saha cihazı veya veri kaynağı<br/>Sorumlu: Ulaşım Veri Platformu ve Analitik Sorumlusu<br/>Birim: Veri, Güvenlik ve Platform Birimi]
    E --> F[Müdahale, test ve servis dönüşü<br/>Sorumlu: Ulaşım Teknolojileri Proje Yöneticisi<br/>Birim: AUS Sistemleri ve Entegrasyon Birimi]
    ...
    H --> I[Test ortamı ve kullanıcı kabulü<br/>Sorumlu: Ulaşım Teknolojileri Proje Yöneticisi<br/>Birim: AUS Sistemleri ve Entegrasyon Birimi]
