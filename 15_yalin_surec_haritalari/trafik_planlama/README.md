...
flowchart TD
    ...
    C --> D[AUS: sensör, kamera ve veri platformu çıktıları<br/>Sorumlu: Ulaşım Veri Platformu ve Analitik Sorumlusu<br/>Birim: Veri, Güvenlik ve Platform Birimi]
    C --> E[Toplu Taşıma: hat, yolcu, filo ve hizmet verileri<br/>Sorumlu: Toplu Taşıma Veri Analisti<br/>Birim: Toplu Taşıma Veri ve Akıllı Filo Birimi]
