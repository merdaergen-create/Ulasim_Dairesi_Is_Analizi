...
```mermaid
flowchart TD
    A([Teknik şubeden teklif dosyası<br/>Sorumlu: İlgili Teknik Şube Pozisyonu]) --> B[UKOME sekretaryası: kayıt ve dosya tamlık kontrolü]
    B --> C{Zorunlu belgeler tam mı?<br/>Sorumlu: Gündem ve Dosya Kabul Sorumlusu}
    C -- Hayır --> D[Eksik belge ve düzeltme listesi<br/>Sorumlu: Gündem ve Dosya Kabul Sorumlusu]
    D --> E[Teknik şube dosyayı tamamlar<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu]
    E --> B
    ...
    J --> K
    K --> L[Gündem ve dosyaların üyelere süresinde gönderilmesi<br/>Sorumlu: Gündem ve Dosya Kabul Sorumlusu]
    L --> M[UKOME toplantısı, görüşme ve oylama<br/>Sorumlu: UKOME Şube Müdürü]
    M --> N{Karar sonucu<br/>Sorumlu: UKOME Şube Müdürü}
    N -- İade --> O[Gerekçe ile teknik şubeye iade<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu]
    O --> E
    ...
    P --> R[Üye imzaları ve kesinleşme kontrolü<br/>Sorumlu: Dijital UKOME Sistem Sorumlusu]
    Q --> R
...
```mermaid
flowchart TD
    A([İmzalı UKOME kararı<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu]) --> B[Karar maddelerinin görev ve süre bazında ayrıştırılması]
    B --> C[Her madde için uygulama sahibi ve hedef tarih<br/>Sorumlu: Karar Uygulama Takip Uzmanı]
    C --> D[EBYS/karar takip sistemi üzerinden bildirim<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu]
    D --> E[Uygulama sahibi: iş planı ve kaynak kontrolü<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu]
    E --> F{Ek proje, bütçe veya ihale gerekli mi?<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu}
    F -- Evet --> G[İlgili teknik/idari hazırlık süreci<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu]
    G --> H[Uygulama<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu]
    F -- Hayır --> H
    H --> I[Fotoğraf, proje, tutanak, belge veya sistem kaydı yükleme<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu]
    I --> J[UKOME sekretaryası: kanıt ve süre kontrolü<br/>Sorumlu: Karar Uygulama Takip Uzmanı]
    J --> K{Karar tam uygulanmış mı?<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu}
    K -- Hayır --> L[Düzeltme veya eksik uygulama bildirimi<br/>Sorumlu: Karar Dağıtım ve Tebligat Personeli]
    L --> M{Hedef süre aşıldı mı?<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu}
    M -- Hayır --> H
    M -- Evet --> N[Daire Başkanı/Genel Sekreterlik escalation raporu<br/>Sorumlu: Karar Uygulama Takip Uzmanı]
    N --> H
    K -- Evet --> O[Gerekirse ortak saha doğrulaması<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu]
    O --> P{Saha uygun mu?<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu}
    P -- Hayır --> L
...
```mermaid
flowchart LR
    A[Başvuru<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu] --> B[Ulaşım Koordinasyon: konu ve yetki sınıflandırması]
    B --> C{UKOME yetkisinde mi?<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu}
    C -- Hayır --> D[Yetkili birime/kuruma yönlendirme<br/>Sorumlu: Kurumlar Arası Koordinasyon Uzmanı]
    C -- Evet --> E[İlgili teknik şubenin belirlenmesi<br/>Sorumlu: Kurumlar Arası Koordinasyon Uzmanı]
    E --> F[Teknik inceleme ve saha/veri çalışması<br/>Sorumlu: İlgili Teknik Şube Pozisyonu]
    F --> G{Kurul kararı gerekli mi?<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu}
    G -- Hayır --> H[Teknik/idari cevap ve başvuru kapanışı<br/>Sorumlu: Karar Uygulama Takip Uzmanı]
    G -- Evet --> I[Standart UKOME teklif dosyası<br/>Sorumlu: İlgili Teknik Şube Pozisyonu]
    I --> J[UK-01 gündem ve karar süreci<br/>Sorumlu: UKOME Şube Müdürlüğü ilgili süreç pozisyonu]
