...
```mermaid
flowchart TD
    A([Onaylı ihtiyaç<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]) --> B[Teknik şube: kapsam, şartname ve miktar]
    B --> C[Teknik şube: yaklaşık maliyet girdileri<br/>Sorumlu: İlgili Teknik Şube Pozisyonu]
    C --> D[İdari İşler: bütçe, ödenek ve satın alma yöntemi kontrolü<br/>Sorumlu: İhale ve Satın Alma Koordinatörü]
    D --> E{Dosya tam ve mevzuata uygun mu?<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu}
    E -- Hayır --> F[Eksik/düzeltme listesi<br/>Sorumlu: İç Kontrol ve Risk Sorumlusu]
    F --> B
    E -- Evet --> G{İhale/temin türü<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu}
    ...
    H --> J[Tekliflerin alınması ve açılması<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    I --> K[Teslim/sipariş kararı<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    J --> L[İhale komisyonu değerlendirmesi<br/>Sorumlu: Yetkili İhale Komisyonu]
    L --> M{Geçerli ve uygun teklif var mı?<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu}
    M -- Hayır --> N[İptal veya yeniden ihale kararı<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    N --> B
    ...
    P --> Q[İş programı ve teknik kontrol ekibine devir<br/>Sorumlu: İlgili Teknik Şube Pozisyonu]
    K --> Q
```
...
```mermaid
flowchart TD
    A([Sözleşme imzalandı<br/>Sorumlu: Sözleşme ve Teminat Sorumlusu]) --> B[İdari İşler: sözleşme takvimi, teminat ve yükümlülük kaydı]
    B --> C[Teknik şube: işe başlama ve kontrol planı<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    C --> D[Yüklenici uygulama/teslim<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    D --> E[Teknik kontrol: miktar, kalite, süre ve kanıt<br/>Sorumlu: İlgili Teknik Şube Pozisyonu]
    E --> F{İş uygun mu?<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu}
    ...
    I --> J{Belgeler tam mı?<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu}
    ...
    N --> O[Mali kontrol ve ödeme<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
...
```mermaid
flowchart TD
    A([Bütçe/rapor dönemi başlar<br/>Sorumlu: Bütçe ve Performans Sorumlusu]) --> B[İdari İşler: takvim, şablon ve veri sözlüğü]
    B --> C[Şubeler: hedef, faaliyet, bütçe ve KPI girişi<br/>Sorumlu: Bütçe ve Performans Sorumlusu]
    C --> D[Otomatik tamlık ve tutarlılık kontrolü<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    D --> E{Veriler tam ve tutarlı mı?<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu}
    E -- Hayır --> F[Düzeltme talebi<br/>Sorumlu: İç Kontrol ve Risk Sorumlusu]
    F --> C
    E -- Evet --> G[İdari İşler: konsolidasyon ve önceki dönem karşılaştırması<br/>Sorumlu: Bütçe ve Performans Sorumlusu]
    G --> H[Daire Başkanı: öncelik ve kaynak değerlendirmesi<br/>Sorumlu: Yetkili İhale Komisyonu]
    H --> I{Revizyon gerekli mi?<br/>Sorumlu: Doküman Kontrol ve Mevzuat Takip Uzmanı}
    I -- Evet --> C
    I -- Hayır --> J[Mali Hizmetler/Strateji birimine gönderim<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    J --> K[Görüş ve bütçe sınırı<br/>Sorumlu: Bütçe ve Performans Sorumlusu]
    K --> L{Uygun mu?<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu}
    L -- Hayır --> G
    L -- Evet --> M[Onaylı bütçe ve performans hedefleri<br/>Sorumlu: Bütçe ve Performans Sorumlusu]
...
```mermaid
flowchart TD
    A([Gelen evrak veya iç yazışma<br/>Sorumlu: EBYS ve Arşiv Sorumlusu]) --> B[EBYS kayıt, güvenlik ve kişisel veri sınıflandırması]
    B --> C[Konu, süre ve yetkili birim belirleme<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    ...
    E --> F{Görüş/onay başka birimden gerekli mi?<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu}
    F -- Evet --> G[EBYS üzerinden görüş talebi<br/>Sorumlu: EBYS ve Arşiv Sorumlusu]
    G --> H[Görüşlerin konsolidasyonu<br/>Sorumlu: Bütçe ve Performans Sorumlusu]
    F -- Hayır --> I[Cevap/olur/işlem taslağı<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    H --> I
    ...
    L --> M{Yasal/idari süre içinde tamamlandı mı?<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu}
    M -- Hayır --> N[Gecikme bildirimi ve escalation<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    M -- Evet --> O([Dosya kapanışı<br/>Sorumlu: EBYS ve Arşiv Sorumlusu])
```
...
```mermaid
flowchart TD
    A([Mal teslimi veya mevcut taşınır işlemi<br/>Sorumlu: Taşınır Kayıt ve Ambar Sorumlusu]) --> B[Muayene-kabul ve belge kontrolü]
    B --> C{Teslim uygun mu?<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu}
    C -- Hayır --> D[Ret/iade veya eksik teslim tutanağı<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    ...
    F --> G{Kullanıcıya teslim mi?<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu}
    ...
    H --> J[Kullanıcı/teknik şube koruma sorumluluğu<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    I --> K[Periyodik stok ve çevre koşulu kontrolü<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    J --> L[Devir, iade, kayıp, arıza veya hurda bildirimi<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    K --> M[Yıl sonu/ara sayım<br/>Sorumlu: Taşınır Kayıt ve Ambar Sorumlusu]
    L --> M
    M --> N[Fiziki kayıt ile sistem karşılaştırması<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    N --> O{Fark var mı?<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu}
    O -- Evet --> P[Sayım farkı inceleme ve mevzuat işlemi<br/>Sorumlu: Taşınır Kayıt ve Ambar Sorumlusu]
    O -- Hayır --> Q[Konsolide cetvel ve kapanış<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    P --> Q
```
...
```mermaid
flowchart TD
    A[Mevzuat/organizasyon/süreç değişikliği<br/>Sorumlu: Doküman Kontrol ve Mevzuat Takip Uzmanı] --> B[İdari İşler: etkilenen dokümanların envanteri]
    B --> C[İlgili şube: içerik ve görev etkisi<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    C --> D[Hukuk Müşavirliği: yetki ve mevzuat kontrolü<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
    D --> E{Uygun mu?<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu}
    E -- Hayır --> F[Revizyon ve çelişki giderme<br/>Sorumlu: Doküman Kontrol ve Mevzuat Takip Uzmanı]
    F --> C
    E -- Evet --> G[Gerekli başkanlık/meclis/kurul onayı<br/>Sorumlu: İdari ve Mali İşler ilgili süreç pozisyonu]
