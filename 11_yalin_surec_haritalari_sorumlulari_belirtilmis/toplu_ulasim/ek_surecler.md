...
```mermaid
flowchart TD
    A([Tahsis, devir veya iptal başvurusu<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]) --> B[Başvuru türü ve kimlik/şirket kontrolü<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]
    B --> C[Plaka, hak, önceki karar ve aktif kayıt araştırması<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]
    C --> D{Başvuru türüne ait belgeler tam mı?<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli}
    ...
    M --> N[Tahsis/devir/iptal belgesinin hazırlanması<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]
    N --> O[Yetkili kontrol, e-imza ve belge numarası<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]
    O --> P[Plaka, hak, ruhsat ve denetim sistemlerinin güncellenmesi<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]
    P --> Q[Eski belge/hak kaydının iptali veya arşivlenmesi<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]
    Q --> R[Başvuru sahibine bildirim ve dosya kapanışı<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]
```
...
```mermaid
flowchart TD
    A([Servis izin başvurusu<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]) --> B[Servis türünün ve hizmet ilişkisinin belirlenmesi<br/>Sorumlu: Servis Araçları İşlemleri Sorumlusu]
    B --> C[Araç, sürücü, rehber ve işletmeci belgelerinin kontrolü<br/>Sorumlu: İşletmeci İlişkileri Sorumlusu]
    ...
    E --> C
    D -- Evet --> F[Plaka/hak, yaş, kapasite, sigorta ve muayene kontrolü<br/>Sorumlu: Filo ve Kapasite Planlama Uzmanı]
...
```mermaid
flowchart TD
    A([Yük veya özel taşıma izin başvurusu<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]) --> B[Taşıma türü, süre ve güzergâh sınıflandırması<br/>Sorumlu: Hat ve Güzergâh Planlama Sorumlusu]
    B --> C[Araç, sürücü, sigorta ve yetki belgelerinin kontrolü<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]
    C --> D{Belgeler tam mı?<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli}
    D -- Hayır --> E[Eksik belge bildirimi<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]
    E --> C
...
```mermaid
flowchart TD
    A([Çalışma ruhsatı veya vize başvurusu<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]) --> B[Plaka, hak ve mevcut ruhsat kaydının doğrulanması<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]
    B --> C[Araç, sürücü, sigorta, muayene ve belge kontrolü<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli]
    C --> D{Belgeler tam ve geçerli mi?<br/>Sorumlu: Başvuru ve Belge Kontrol Personeli}
