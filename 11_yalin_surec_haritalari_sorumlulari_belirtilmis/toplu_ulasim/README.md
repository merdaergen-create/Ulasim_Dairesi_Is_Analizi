...
flowchart TD
    ...
    B --> C[AUS: araç, yolcu ve zaman verisi<br/>Sorumlu: Ulaşım Veri Platformu ve Analitik Sorumlusu]
    C --> D[Alternatif hat/güzergâh/zaman senaryoları<br/>Sorumlu: Hat ve Güzergâh Planlama Sorumlusu]
    D --> E[Ulaşım Planlama: yol kapasitesi ve geometri kontrolü<br/>Sorumlu: Yol ve Kavşak Tasarım Sorumlusu]
    E --> F[Maliyet, filo, tarife ve sosyal etki analizi<br/>Sorumlu: Tarife ve Maliyet Analizi Uzmanı]
    F --> G{Hizmet ve mali kriterler uygun mu?<br/>Sorumlu: Toplu Taşıma Şube Müdürü}
    G -- Hayır --> D
    ...
    J --> K{Karar sonucu<br/>Sorumlu: Toplu Taşıma Şube Müdürü}
    K -- İade/Ret --> L[Gerekçe ve senaryo revizyonu<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    L --> D
    K -- Kabul --> M[Hat, ruhsat, biletleme ve yolcu bilgi sistemlerinin güncellenmesi<br/>Sorumlu: Hat ve Güzergâh Planlama Sorumlusu / Ruhsat ve Vize Birim Sorumlusu / Akıllı Filo Operasyon Sorumlusu]
    ...
    O --> P{Hedefler sağlandı mı?<br/>Sorumlu: Toplu Taşıma Şube Müdürü}
    P -- Hayır --> D
    P -- Evet --> Q([Süreç kapanışı ve periyodik izleme<br/>Sorumlu: Toplu Taşıma Şube Müdürü])
```
...
flowchart TD
    ...
    I --> K{Uygun mu?<br/>Sorumlu: Toplu Taşıma Şube Müdürü}
    K -- Hayır --> L[Gerekçeli uygunsuzluk ve düzeltme süresi<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    L --> I
    K -- Evet --> J
    J --> M[Tahsilat doğrulaması<br/>Sorumlu: Tahakkuk ve Tarife Kontrol Personeli]
    M --> N{Tüm koşullar tamam mı?<br/>Sorumlu: Toplu Taşıma Şube Müdürü}
    ...
    P --> Q[Denetim sistemine ve süre takvimine aktarım<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
...
```mermaid
flowchart TD
    A([Planlı kontrol veya şikâyet<br/>Sorumlu: Hizmet Kalitesi ve KPI Sorumlusu]) --> B[Kayıt, konu ve yetki sınıflandırması<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    B --> C{Masa başında doğrulanabilir mi?<br/>Sorumlu: Toplu Taşıma Şube Müdürü}
    C -- Evet --> D[AUS, ruhsat ve sefer kayıtlarının incelenmesi<br/>Sorumlu: Hat ve Güzergâh Planlama Sorumlusu]
    C -- Hayır --> E[Saha kontrol planı<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    E --> F{Kolluk katılımı gerekli mi?<br/>Sorumlu: Toplu Taşıma Şube Müdürü}
    F -- Evet --> G[Kolluk koordinasyonu/refakat<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    F -- Hayır --> H[Belediye görev sınırı içinde saha kontrolü<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    G --> I[Standart kontrol formu ve kanıt<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    H --> I
    D --> J{İhlal veya hizmet kusuru var mı?<br/>Sorumlu: Hizmet Kalitesi ve KPI Sorumlusu}
    I --> J
    J -- Hayır --> K[Sonuç bildirimi ve kayıt kapanışı<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    J -- Evet --> L[İhlalin türü ve yetkili makamın belirlenmesi<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    L --> M{Belediyenin düzeltme/işlem yetkisi var mı?<br/>Sorumlu: Toplu Taşıma Şube Müdürü}
    M -- Evet --> N[Düzeltici işlem, süre ve takip<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    M -- Hayır --> O[Yetkili kolluk/kuruma kanıtlı bildirim<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    N --> P{Düzeltme tamamlandı mı?<br/>Sorumlu: Toplu Taşıma Şube Müdürü}
    P -- Hayır --> Q[Escalation ve sözleşme/ruhsat hükümleri<br/>Sorumlu: Ruhsat ve Vize Birim Sorumlusu]
    Q --> N
    P -- Evet --> R[Dosya kapanışı<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    O --> R
...
```mermaid
flowchart TD
    A([Yeni durak veya yer değişikliği ihtiyacı<br/>Sorumlu: Durak Hizmetleri Planlama Uzmanı]) --> B[Toplu Taşıma: hizmet ve yolcu talebi analizi<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    B --> C[Ulaşım Planlama: yol, görüş, yaya ve trafik güvenliği kontrolü<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    C --> D[Erişilebilirlik ve yürüme bağlantısı kontrolü<br/>Sorumlu: Durak Hizmetleri Planlama Uzmanı]
    D --> E{Yer uygun mu?<br/>Sorumlu: Toplu Taşıma Şube Müdürü}
    E -- Hayır --> F[Alternatif yer analizi<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    F --> C
    E -- Evet --> G[UKOME teknik teklif ve karar<br/>Sorumlu: Gündem ve Dosya Kabul Sorumlusu / UKOME Karar Yazım Uzmanı]
    G --> H{Karar olumlu mu?<br/>Sorumlu: Toplu Taşıma Şube Müdürü}
    H -- Hayır --> F
    H -- Evet --> I[Durak tipi, ölçü ve iş programı<br/>Sorumlu: Durak Hizmetleri Planlama Uzmanı]
    I --> J[Ulaşım Planlama/Fen: fiziksel montaj<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    J --> K[AUS: akıllı ekran, enerji ve haberleşme<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    K --> L[Ortak teknik ve erişilebilirlik kabulü<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    L --> M{Kabul uygun mu?<br/>Sorumlu: Toplu Taşıma Şube Müdürü}
    M -- Hayır --> N[Düzeltme iş emri<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    N --> L
    M -- Evet --> O[Tekil durak ID, CBS ve yolcu bilgi sistemine kayıt<br/>Sorumlu: Durak Hizmetleri Planlama Uzmanı]
    O --> P[Arıza ve bakım çağrılarının ekipman türüne göre yönlendirilmesi<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
```
...
flowchart LR
    ...
    C -- Hayır --> D[Periyodik rapor ve izleme<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
    ...
    F --> G[Uygulama ve 30 günlük yeniden ölçüm<br/>Sorumlu: Toplu Taşıma Şube Müdürü]
