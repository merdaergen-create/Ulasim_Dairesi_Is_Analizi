...
```mermaid
flowchart TD
    A([Onaylı ihtiyaç<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]) --> B[Teknik şube: kapsam, şartname ve miktar<br/>Sorumlu: İlgili Teknik Şubenin Yalın Pozisyonu]
    ...
    F --> B
    E -- Evet --> G{İhale/temin türü<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü}
    ...
    H --> J[Tekliflerin alınması ve açılması<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    I --> K[Teslim/sipariş kararı<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    J --> L[İhale komisyonu değerlendirmesi<br/>Sorumlu: Yetkili İhale Komisyonu]
    L --> M{Geçerli ve uygun teklif var mı?<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü}
    M -- Hayır --> N[İptal veya yeniden ihale kararı<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    N --> B
...
flowchart TD
    ...
    B --> C[Teknik şube: işe başlama ve kontrol planı<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    C --> D[Yüklenici uygulama/teslim<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    D --> E[Teknik kontrol: miktar, kalite, süre ve kanıt<br/>Sorumlu: İlgili Teknik Şubenin Yalın Pozisyonu]
    E --> F{İş uygun mu?<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü}
    ...
    I --> J{Belgeler tam mı?<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü}
    ...
    N --> O[Mali kontrol ve ödeme<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
...
flowchart TD
    ...
    C --> D[Otomatik tamlık ve tutarlılık kontrolü<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    D --> E{Veriler tam ve tutarlı mı?<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü}
    E -- Hayır --> F[Düzeltme talebi<br/>Sorumlu: İç Kontrol ve Risk Sorumlusu]
    F --> C
    E -- Evet --> G[İdari İşler: konsolidasyon ve önceki dönem karşılaştırması<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    ...
    I -- Evet --> C
    I -- Hayır --> J[Mali Hizmetler/Strateji birimine gönderim<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    J --> K[Görüş ve bütçe sınırı<br/>Sorumlu: İhale ve Satın Alma Koordinatörü]
    K --> L{Uygun mu?<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü}
    L -- Hayır --> G
...
flowchart TD
    ...
    B --> C[Konu, süre ve yetkili birim belirleme<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    ...
    E --> F{Görüş/onay başka birimden gerekli mi?<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü}
    F -- Evet --> G[EBYS üzerinden görüş talebi<br/>Sorumlu: EBYS ve Arşiv Sorumlusu]
    G --> H[Görüşlerin konsolidasyonu<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    F -- Hayır --> I[Cevap/olur/işlem taslağı<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    H --> I
    ...
    L --> M{Yasal/idari süre içinde tamamlandı mı?<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü}
    M -- Hayır --> N[Gecikme bildirimi ve escalation<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    M -- Evet --> O([Dosya kapanışı<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü])
```
...
flowchart TD
    ...
    B --> C{Teslim uygun mu?<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü}
    C -- Hayır --> D[Ret/iade veya eksik teslim tutanağı<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    ...
    F --> G{Kullanıcıya teslim mi?<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü}
    ...
    H --> J[Kullanıcı/teknik şube koruma sorumluluğu<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    I --> K[Periyodik stok ve çevre koşulu kontrolü<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    J --> L[Devir, iade, kayıp, arıza veya hurda bildirimi<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    K --> M[Yıl sonu/ara sayım<br/>Sorumlu: Taşınır Kayıt ve Ambar Sorumlusu]
    L --> M
    M --> N[Fiziki kayıt ile sistem karşılaştırması<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    N --> O{Fark var mı?<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü}
    O -- Evet --> P[Sayım farkı inceleme ve mevzuat işlemi<br/>Sorumlu: Taşınır Kayıt ve Ambar Sorumlusu]
    O -- Hayır --> Q[Konsolide cetvel ve kapanış<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    P --> Q
```
...
flowchart TD
    ...
    B --> C[İlgili şube: içerik ve görev etkisi<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
    C --> D[Hukuk Müşavirliği: yetki ve mevzuat kontrolü<br/>Sorumlu: Doküman Kontrol ve Mevzuat Takip Uzmanı]
    D --> E{Uygun mu?<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü}
    E -- Hayır --> F[Revizyon ve çelişki giderme<br/>Sorumlu: Doküman Kontrol ve Mevzuat Takip Uzmanı]
    F --> C
    E -- Evet --> G[Gerekli başkanlık/meclis/kurul onayı<br/>Sorumlu: İdari ve Mali İşler Şube Müdürü]
