# 10 — Yalın Pozisyon Görev Tanımları

Bu klasör, `09_yalin_pozisyonlari` altında tanımlanan 8 şubeli yalın organizasyondaki pozisyonların görev tanımlarını içerir. Görevler, `05_surec_haritalari` içindeki süreç adımları esas alınarak oluşturulmuştur.

## Dosyalar

1. [Ulaşım Planlama](01_ulasim_planlama_yalin_gorev_tanimlari.md)
2. [Trafik Hizmetleri ve Sinyalizasyon](02_trafik_hizmetleri_sinyalizasyon_yalin_gorev_tanimlari.md)
3. [AUS ve Trafik Yönetim Merkezi](03_aus_tkm_yalin_gorev_tanimlari.md)
4. [Toplu Taşıma Planlama ve İşletme](04_toplu_tasima_yalin_gorev_tanimlari.md)
5. [Ulaşım Ruhsat ve Ticari Araç İşlemleri](05_ulasim_ruhsat_yalin_gorev_tanimlari.md)
6. [UKOME](06_ukome_yalin_gorev_tanimlari.md)
7. [Otogar İşletme](07_otogar_yalin_gorev_tanimlari.md)
8. [İdari ve Mali İşler](08_idari_mali_isler_yalin_gorev_tanimlari.md)
9. [Ortak Pozisyonlar](09_ortak_pozisyonlar_yalin_gorev_tanimlari.md)

## Ortak görev tanımı standardı
