# Ulaşım Planlama Şube Müdürlüğü — Yalın Görev Tanımları
...
**Süreç adımları ve görevler:**
- Plan/revizyon ihtiyacını değerlendirir; kapsam ve çalışma programını onaylar.
- Ulaşım ana planı senaryoları, tercih edilen plan, yatırım programı ve KPI setini değerlendirir.
- Yol, kavşak, geçiş yolu ve geçici trafik planı teknik dosyalarını onaylar.
- UKOME’ye gönderilecek teknik tekliflerin yeterliliğini ve süreç sahibini doğrular.
- Trafik eğitimi yıllık programı, kapasitesi ve faaliyet sonuçlarını izler.

**Çıktılar:** Onaylı teknik dosya, yıllık iş programı, yatırım önceliği, yönetim raporu.

**Yetki sınırı:** UKOME/Meclis kararı, ihale kararı ve mali ödeme tesis etmez.
...
**Görevler:** Model girdilerini tanımlar, kalibrasyon yapar, senaryoları karşılaştırır, yatırım alternatiflerini ve izleme göstergelerini hazırlar.

**Çıktılar:** Ulaşım modeli, senaryo raporu, yatırım programı, model doğrulama kaydı.
...
**Görevler:** Etüt planı hazırlar, saha verisini doğrular, anomali ve trend analizi yapar, teknik raporlara veri sağlar.

**Çıktılar:** Etüt veri seti, kalite raporu, yoğunluk/kaza analizi.
...
**Görevler:** Geometrik alternatifleri üretir, imar/mülkiyet/altyapı görüşlerini toplar, teknik teklif ve uygulama projesini hazırlar.

**Çıktılar:** Avan/uygulama projesi, UKOME teknik dosyası, uygulama paketi.
...
**Görevler:** Kara nokta ve okul çevresi analizi yapar, güvenlik denetimi yürütür, sürdürülebilir ulaşım önerileri geliştirir.

**Çıktılar:** Güvenlik denetim raporu, risk öncelik listesi, erişilebilirlik görüşü.
...
**Görevler:** Yol, kavşak, durak ve proje katmanlarını yönetir; tekil ID, koordinat ve sürüm bütünlüğünü sağlar.

**Çıktılar:** Güncel CBS katmanı, varlık kaydı, değişiklik geçmişi.
...
**Görevler:** Proje, metraj girdisi ve uygulama kanıtlarını kontrol eder; uygunsuzluğu gerekçeli olarak düzeltmeye iade eder.

**Çıktılar:** Kontrol raporu, uygunsuzluk listesi, teknik kabul görüşü.

**Yetki sınırı:** Muayene-kabul komisyonu yerine geçmez.
...
**Görevler:** Yıllık programı, müfredatı, paydaş takvimini ve kampanyaları hazırlar; sonuçları raporlar.
...
**Görevler:** Eğitimi uygular, katılımcı güvenliğini gözetir, kazanımı ölçer ve kayıtları tamamlar.
...
**Görevler:** Parkı seansa hazırlar, ekipman ve güvenlik kontrollerini yapar, arıza ve ramak kala kayıtlarını yönetir.

**KPI:** Güvenli seans oranı, arıza kapanış süresi, kapasite kullanımı, olay sayısı.

## Ortak hükümler
Tüm pozisyonlar süreç kayıtlarını EBYS/kurumsal sistemde tutar; kişisel veriye rol bazlı erişir; görev devri ve vekâleti yazılı yürütür; mevzuata aykırılık ve kritik riski amirine bildirir.
